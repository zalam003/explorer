defmodule BlockScoutWeb.ChainView do
  ...
  def format_currency_value(value, symbol) when value >= 1_000_000 and value <= 999_000_000 do
    {:ok, value} = Cldr.Number.to_string(value, format: :short, fractional_digits: 2)
    "#{symbol}#{value}"
  end
